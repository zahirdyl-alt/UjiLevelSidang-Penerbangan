    ...
    if (isset($_POST['action'])) {
        if ($_POST['action'] == 'add') {
            ...
            if (!empty($nama) && !empty($jabatan)) {
                ...
                $success_message = "Anggota OSIS berhasil ditambahkan!";
            }
...
$current_visi = $vm_data['osis']['visi'] ?? '';
$current_misi = $vm_data['osis']['misi'] ?? '';

// Read data
$osis_data = [];
if (file_exists($file)) {
    $osis_data = json_decode(file_get_contents($file), true) ?? [];
}
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Edit Anggota OSIS - Dashboard Admin</title>
...
<body>
    ...
    <div class="dashboard-wrapper">
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="osis.php" class="active">Edit Anggota [Osis]</a></li>
        ...
        <main class="main-content">
            <div class="welcome-banner" style="background-color: #0284c7;">
            ...
            <div class="table-container">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h3 class="table-title" style="margin-bottom: 0;">Daftar Anggota OSIS</h3>
                    <div>
                ...
                <div class="table-responsive">
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php $no = 1; foreach($osis_data as $anggota): 
                                    $img_src = !empty($anggota['foto']) ? '../uploads/osis/' . htmlspecialchars($anggota['foto']) : 'https://ui-avatars.com/api/?name=' . urlencode($anggota['nama']) . '&background=0284c7&color=fff';
                                ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td>
                                    ...
                                    <td><span style="background: #e0f2fe; color: #0284c7; padding: 4px 10px; border-radius: 20px; font-size: 0.85rem; font-weight: 600;"><?= htmlspecialchars($anggota['jabatan']) ?></span></td>
                                    <td>
                                        ...
                                        <form action="osis.php" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus anggota ini?');">
    ...
    <div id="modalTambah" class="modal-overlay">
        <div class="modal-content">
            ...
            <form action="osis.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="jabatan" name="jabatan" class="form-control" required placeholder="Contoh: Ketua OSIS">
                </div>
                <div class="form-group">
